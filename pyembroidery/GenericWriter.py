        ...
        self.format_dictionary.update(
            {
                ...
                "extents_top": bounds[1],
                "extents_right": bounds[2],
                "extents_bottom": bounds[3],
                "extents_width": width,
                "extents_height": height,
                "extents_left_mm": bounds[0] / 10.0,
                "extents_top_mm": bounds[1] / 10.0,
                "extents_right_mm": bounds[2] / 10.0,
                "extents_bottom_mm": bounds[3] / 10.0,
                "extents_width_mm": width / 10.0,
                "extents_height_mm": height / 10.0,
            }
        )
