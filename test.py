...
for i in range(0,10000):
    pattern3.add_stitch_relative(STITCH, 0.3333, 0.33333)

write(pattern3, "example.jef")
write(pattern3, "example.pec")
write(pattern3, "example.pes")
write(pattern3, "example.vp3")
write(pattern3, "example.dst")
write(pattern3, "example.exp")
