...
class TestConverts(unittest.TestCase):
    ...
    def test_generic_write_gcode(self):
        gcode_writer_dict = {
            ...
            "(EXTENTS_TOP: {extents_top:.3f})\n"
            "(EXTENTS_RIGHT: {extents_right:.3f})\n"
            "(EXTENTS_BOTTOM: {extents_bottom:.3f})\n"
            "(EXTENTS_WIDTH: {extents_width:.3f})\n"
            "(EXTENTS_HEIGHT: {extents_height:.3f})\n"
